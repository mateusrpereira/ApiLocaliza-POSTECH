...
namespace Api.Service.Services
{
    public class LoginService : ILoginService
    {
        ...
        public LoginService(IUserRepository repository, SigningConfigurations signinConfigurations, TokenConfigurations tokenConfigurations, IConfiguration configuration)
        {
